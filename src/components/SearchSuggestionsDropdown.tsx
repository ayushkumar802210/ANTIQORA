  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="absolute top-full left-0 right-0 mt-2 rounded-2xl border border-slate-200/90 dark:border-slate-800 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl shadow-2xl overflow-hidden z-50 text-left divide-y divide-slate-100 dark:divide-slate-800/60"
        role="listbox"
